finalni_projekt2
Odevzdání úkolu č. 2
test.calculator.py from playwright.sync_api import sync_playwright

def test_calculator(): with sync_playwright() as p: browser = p.chromium.launch(headless=False) page = browser.new_page()
    ...
    browser.close()
if name == "main": test_calculator()

finalni_projekt2
Odevzdání úkolu č. 2
test.calculator2.py from playwright.sync_api import sync_playwright
...
finalni_projekt2
Odevzdání úkolu č. 2
test.calculator3.py from playwright.sync_api import sync_playwright
...
finalni_projekt2
Odevzdání úkolu č. 2
test.calculator4.py from playwright.sync_api import sync_playwright
...
finalni_projekt2
Odevzdání úkolu č. 2
test.calculator5.py from playwright.sync_api import sync_playwright
